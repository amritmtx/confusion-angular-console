...
export class DishdetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    .subscribe(dish => {
      ...
      err => console.log(err));
      this.commentservice.getComments(this.dish._id).subscribe(comments => this.comments = comments, err => console.log(err));
    },
  ...
  onSubmit() {
    ...
    this.commentservice.postComment(commentsObj)
      .subscribe(comments => this.comments.push(comments));
